...
namespace Simone.Data.Migrations
{
    ...
    [Migration("20251016024427_HardeningProductoVarianteYGaleria")]
    partial class HardeningProductoVarianteYGaleria
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Simone.Models.ProductoVariante", b =>
                {
                    ...
                    b.ToTable("ProductoVariantes", t =>
                        {
                            t.HasCheckConstraint("CK_ProductoVariante_Valores", "[PrecioVenta] > 0 AND [Stock] >= 0");
                        });
                });
