...
namespace Simone.Migrations
{
    ...
    [Migration("20250226210003_PermitirFechaAgregadoNulo")]
    partial class PermitirFechaAgregadoNulo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simone.Models.Pedidos", b =>
                {
                    b.Property<int>("PedidoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Simone.Models.Productos", b =>
                {
                    b.Property<int>("ProductoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Simone.Models.AuditoriaProductos", b =>
                {
                    b.HasOne("Simone.Models.Productos", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("Simone.Models.DetallesPedido", b =>
                {
                    b.HasOne("Simone.Models.Pedidos", "Pedido")
